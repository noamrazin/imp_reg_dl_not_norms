...
class MetricsPlotter(Callback):
    ...
    def __init__(self, output_dir, create_dir=True, create_plots_interval=5, exclude=None):
        """
    ...
    def __create_plots(self, train_metric_infos, train_tracked_values, val_metric_infos, val_tracked_values,
    ...
    def __get_aggregated_tracked_values_by_tag(self, train_metric_infos, train_tracked_values, val_metric_infos, val_tracked_values,
        ...
        self.__populate_by_tag_tracked_values(aggregated_by_tag_tracked_values, train_metric_infos, train_tracked_values, consts.TRAIN_PHASE)
        self.__populate_by_tag_tracked_values(aggregated_by_tag_tracked_values, val_metric_infos, val_tracked_values, consts.VALIDATION_PHASE)
    ...
    def __populate_by_tag_tracked_values(self, aggregated_by_tag_tracked_values, metric_infos, tracked_values, phase):
        ...
        for metric_name, metric_info in metric_infos.items():
            ...
            aggregated_by_tag_tracked_values[metric_info.tag][metric_plot_name] = tracked_values[metric_name]
    ...
    def __populate_by_tag_other_tracked_values(self, aggregated_by_tag_tracked_values, other_tracked_values):
        ...
        for name, tracked_value in tracked_values.items():
            ...
            metric_plot_name = self.__create_metric_plot_name(consts.OTHER, self.__escape_metric_name(name))
            aggregated_by_tag_tracked_values[tag][metric_plot_name] = tracked_value
